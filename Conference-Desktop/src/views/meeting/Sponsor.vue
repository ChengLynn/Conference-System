    ...
    <div v-if="currentView === 'list'">
      ...
      <div class="content-card table-section">
        <el-table :data="tableData" style="width: 100%" stripe>
          ...
          <el-table-column prop="totalSponsorship" label="总赞助金额" width="180" align="center">
            <template #default="{ row }">
              <span>{{ row.totalSponsorship }}</span>
            </template>
          </el-table-column>

          <el-table-column prop="sponsorCompanies" label="赞助企业数" width="150" align="center">
            <template #default="{ row }">
              <span>{{ row.sponsorCompanies }}</span>
            </template>
          </el-table-column>
    ...
    <div v-if="currentView === 'detail'">
          ...
          <div class="stat-icons">
            <div class="stat-icon-item">
              ...
              <div class="stat-icon-content">
                <div class="stat-icon-label">总赞助金额</div>
                <div class="stat-icon-value">200万元</div>
              </div>
            </div>
          </div>
          <div class="stat-icons">
            <div class="stat-icon-item">
              ...
              <div class="stat-icon-content">
                <div class="stat-icon-label">赞助企业</div>
                <div class="stat-icon-value">10家</div>
              </div>
            </div>
          </div>
          <div class="stat-icons">
            <div class="stat-icon-item">
              ...
              <div class="stat-icon-content">
                <div class="stat-icon-label">今日新增</div>
                <div class="stat-icon-value">2家</div>
              </div>
            </div>
          </div>
          <div class="stat-icons">
            <div class="stat-icon-item">
              ...
              <div class="stat-icon-content">
                <div class="stat-icon-label">较新增金额</div>
                <div class="stat-icon-value">25000元</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="content-card-signup" style="margin-top: 20px">
        ...
        <div class="table-section">
          <el-table :data="sponsorData" style="width: 100%" stripe tooltip-effect="dark">
            <el-table-column prop="company" label="赞助单位" min-width="200" />
            <el-table-column
              prop="project"
              label="赞助项目"
              min-width="150"
            ...
            />
            <el-table-column prop="amount" label="赞助金额" width="200" align="right">
              <template #default="{ row }">
                <span>¥{{ row.amount }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="paymentMethod" label="入账方式" width="200" align="center" />
            <el-table-column prop="paymentTime" label="付款时间" width="180" />
            <el-table-column prop="contact" label="赞助方联系" width="150" />
            ...
            >
              <template #default="{ row }">
                <el-button type="primary" size="small">{{ row.coordinator }}</el-button>
              </template>
            </el-table-column>
...
const tableData = ref<ConferenceItem[]>([
  {
    ...
    totalSponsorship: '¥500,000',
    sponsorCompanies: '15家',
  ...
  },
  {
    ...
    totalSponsorship: '¥300,000',
    sponsorCompanies: '10家',
    filePath: '',
    editors: ['Iris'],
    designItems: 'karl',
  },
  {
    id: 3,
    name: '2025世界油商大会',
    totalSponsorship: '¥800,000',
    sponsorCompanies: '20家',
    filePath: '',
    editors: ['Iris'],
    designItems: 'karl',
  },
...
const sponsorData = ref([
  {
    ...
    amount: '10,000',
    paymentMethod: '对公账户',
    paymentTime: '2025/12/01 16:19:15',
    contact: '12345678910',
    remark: '',
    coordinator: '张明',
  },
  {
    ...
    amount: '50,000',
    paymentMethod: '对公账户',
    paymentTime: '2025/12/02 10:30:22',
    contact: '13800138000',
    remark: '',
    coordinator: '王芳',
  },
  {
    ...
    amount: '15,000',
    paymentMethod: '银行转账',
    paymentTime: '2025/12/03 14:20:08',
    contact: '13912345678',
    remark: '',
    coordinator: '王芳',
  },
  {
    ...
    amount: '8,000',
    paymentMethod: '微信支付',
    paymentTime: '2025/12/04 09:15:33',
    contact: '13687654321',
    remark: '',
    coordinator: '王芳',
  },
...
:deep(.el-table .el-table__cell .number) {
